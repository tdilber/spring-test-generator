...
public class IntegrationTestGenerator implements ApplicationRunner {
    ...
    public IntegrationTestGenerator(ApplicationContext applicationContext, RequestMappingHandlerMapping requestMappingHandlerMapping, List<EntityMapper<?, ?>> entityMapperList, List<JpaRepository<?, ?>> jpaRepositoryList, EntityManager entityManager) {
